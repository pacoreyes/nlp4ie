...
from lib.stance_markers_adj import (
  create_positive_adj, create_positive_adj_negation, create_positive_adj_phrase,
  create_negative_adj, create_negative_adj_negation, create_negative_adj_phrase,
  create_certainty_adj, create_certainty_adj_negation, create_certainty_adj_phrase,
  create_doubt_adj, create_doubt_adj_negation,
  create_emphatic_adj, create_emphatic_adj_negation, create_emphatic_adj_phrase, create_emphatic_adj_patterns,
  create_hedge_adj, create_hedge_adj_negation,
  create_pro_adj, create_pro_adj_negation, create_pro_adj_patterns,
  create_con_adj, create_con_adj_negation, create_con_adj_phrase, create_con_adj_patterns
)

# Import stance markers for adverbs
from lib.stance_markers_adv import (
  create_positive_adv, create_positive_adv_negation,
  create_negative_adv, create_negative_adv_negation,
  create_certainty_adv, create_certainty_adv_negation, create_certainty_adv_phrase,
  create_doubt_adv, create_doubt_adv_negation,
  create_emphatic_adv, create_emphatic_adv_negation, create_emphatic_adv_phrase, create_emphatic_adv_patterns,
  create_hedge_adv, create_hedge_adv_negation, create_hedge_adv_phrase,
  create_pro_adv, create_pro_adv_negation, create_pro_adv_phrase,
  create_con_adv, create_con_adv_negation, create_con_adv_phrase, create_con_adv_patterns
)

# Import stance markers for verbs
from lib.stance_markers_verb import (
  create_positive_verb, create_positive_verb_negation,
  create_negative_verb, create_negative_verb_negation,
  create_certainty_verb, create_certainty_verb_negation, create_certainty_verb_phrase, create_certainty_verb_patterns,
  create_doubt_verb, create_doubt_verb_negation,
  create_emphatic_verb, create_emphatic_verb_negation, create_emphatic_verb_phrase, create_emphatic_verb_patterns,
  create_hedge_verb, create_hedge_verb_negation, create_hedge_verb_phrase,
  create_pro_verb, create_pro_verb_negation, create_pro_verb_phrase, create_pro_verb_patterns,
  create_con_verb, create_con_verb_negation, create_con_verb_phrase, create_con_verb_patterns
)

# Import stance markers for modality
from lib.stance_markers_modals import (
  create_predictive_modal, create_predictive_modal_phrase,
  create_possibility_modal,
  create_necessity_modal, create_necessity_modal_phrase
)
...
def extract_stance_features(_doc, pos, feature, label, use_patterns=False):
  """
...
for _idx, d in enumerate([dataset_train, dataset_test]):
  ...
  for datapoint in d:
    ...
    _pro_adj = extract_stance_features(_doc, "ADJ", "pro", _label, use_patterns=True)
    _con_adj = extract_stance_features(_doc, "ADJ", "con", _label, use_patterns=True)
    ...
    _emphatic_adv = extract_stance_features(_doc, "ADV", "emphatic", _label, use_patterns=True)
    _hedge_adv = extract_stance_features(_doc, "ADV", "hedge", _label)
    _pro_adv = extract_stance_features(_doc, "ADV", "pro", _label)
    _con_adv = extract_stance_features(_doc, "ADV", "con", _label, use_patterns=True)
    ...
    _certainty_verb = extract_stance_features(_doc, "VERB", "certainty", _label, use_patterns=True)
    _doubt_verb = extract_stance_features(_doc, "VERB", "doubt", _label)
    _emphatic_verb = extract_stance_features(_doc, "VERB", "emphatic", _label, use_patterns=True)
    _hedge_verb = extract_stance_features(_doc, "VERB", "hedge", _label)
    _pro_verb = extract_stance_features(_doc, "VERB", "pro", _label, use_patterns=True)
    _con_verb = extract_stance_features(_doc, "VERB", "con", _label, use_patterns=True)
