...
from lib.utils import save_row_to_jsonl_file, empty_json_file, read_from_google_sheet
...
dataset = load_jsonl_file("shared_data/dataset_2_6_pair_sentences_gs.jsonl")
...
def objective(trial):
    ...
    losses_plot_filename = (
      ...
      f"lr_paper_b_{LEARNING_RATE}_batch_{BATCH_SIZE}_warmup_{WARMUP_STEPS}_epochs_{NUM_EPOCHS}.png"
    )
    ...
    if test_accuracy > trial.user_attrs.get("best_test_accuracy", 0):
        ...
        best_model_path = f"models/2/paper_b_x_dl_bert_train_hop_bert.pth"
...
"""
Best is trial 17 with value: 0.6702127659574468. 
"""
