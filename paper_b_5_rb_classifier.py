...
# Example usage
# sent1 = "The Iraqis have been trying to acquire weapons of mass destruction."
# sent2 = "That's the only explanation for why Saddam Hussein does not want inspectors in from the U.N."

# sent1 = "That's the only explanation for why Saddam Hussein does not want inspectors in from the U.N."
# sent2 = "Iraq continues to be unable to say that its neighbors have a right to exist, like Kuwait."

# sent1 = "That was true before September 11th, that's true now."
# sent2 = "The Iraqis have been trying to acquire weapons of mass destruction."

"""sent1 = "Iraq continues to be unable to say that its neighbors have a right to exist, like Kuwait."
sent2 = "So there is plenty of reason to watch Iraq, there is plenty of reason to make very clear to the Iraqis that the United States does not intend to let the Iraqis threaten their own people, threaten their neighbors, or threaten our interests by acquiring weapons of mass destruction."

continuity = check_lexical_continuity(sent1, sent2, nlp)
pprint(continuity)
continuity2 = check_syntactic_continuity(sent1, sent2, nlp)
pprint(continuity2)
continuity3 = check_semantic_continuity(sent1, sent2, nlp)
pprint(continuity3)
continuity4 = check_transition_markers_continuity(sent2)
pprint(continuity4)
continuity5 = check_coreference(sent1, sent2, nlp, nlp_sm_coref)
pprint(continuity5)"""
